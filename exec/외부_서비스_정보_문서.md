...
<img src="./산출물/teachablemachine_mainpage.png" alt="image-20220405151943238" style="zoom:50%;" />

2. 포즈 프로젝트를 사용하였습니다
3. 운동을 `운동자세`와 `대기자세`로 나누어 샘플을 촬영합니다

<img src="./산출물/sample_input.png" alt="image-20220405152306082" style="zoom:50%;" />

4. 모델 학습하기 버튼을 통해, 촬영한 샘플들로 `자세인식 모델`을 만들 수 있습니다 

   > 만든 모델은 `자세`만 인식하며, 후술할 과정들을 통해 운동인식으로 만들어주어야 합니다

   <img src="./산출물/model_learning.png" alt="image-20220405153205165" style="zoom: 50%;" />
...
<img src="./산출물/model_code_export.png" alt="image-20220405152955295" style="zoom: 33%;" />
